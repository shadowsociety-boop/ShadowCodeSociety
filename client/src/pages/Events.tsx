        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {events.map((event) => {
            ...
            return (
              <div
                key={event.id}
                className="group relative bg-[#0B0B0B] border border-white/[0.08] hover:border-white/20 rounded-lg p-6 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1"
              >
