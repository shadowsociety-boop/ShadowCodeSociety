          ...
          {highlights.map((item, idx) => {
            ...
            return (
              <div
                ...
                className={`${colSpan} group relative bg-[#0B0B0B] border border-white/[0.08] hover:border-white/20 rounded-lg overflow-hidden cursor-pointer transition-all duration-300 min-h-[300px] flex flex-col justify-end p-6`}
              >
