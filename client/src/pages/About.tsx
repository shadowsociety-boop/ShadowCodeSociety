  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 text-left space-y-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-6">
        ...
        <div className="lg:col-span-6 space-y-4 font-sans text-sm sm:text-base text-[#A1A1A1] leading-relaxed">
          <p>
      ...
      <div className="space-y-6 pt-10 border-t border-white/[0.08]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {pillars.map((pillar) => (
            <div
              key={pillar.num}
              className="bg-[#0B0B0B] border border-white/[0.08] rounded-lg p-8 space-y-3"
            >
      ...
      <div className="space-y-6 pt-10 border-t border-white/[0.08]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {ethicsRules.map((rule) => (
            <div
              key={rule.num}
              className="bg-[#080808] border border-white/[0.07] rounded-lg p-6 space-y-2"
            >
