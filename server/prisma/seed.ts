...
async function main() {
  ...
  const members = [
    ...
    },
    {
      ...
      skills: JSON.stringify(['Network Security', 'Systems Architecture', 'Cyber Defense', 'Python', 'Linux']),
      status: 'CURRENT',
      order: 6,
      joinYear: 2024,
    },
    ...
    // Public Relations & Media Domain
    {
      ...
      skills: JSON.stringify(['Public Relations', 'Brand Strategy', 'Community Outreach', 'Communications']),
      status: 'CURRENT',
      order: 12,
      joinYear: 2024,
    },
